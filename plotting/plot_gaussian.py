...
ax_time.set_title("Time Domain: Sine Waves (220, 440, 1590 Hz) + Gaussian Noise")
ax_time.grid(True)
...
ax_kaiser.set_title("Frequency Spectrum (220, 440, 1590 Hz) with Kaiser Windows (Gaussian Noise)")
...
ax_hamming.set_title("Frequency Spectrum (220, 440, 1590 Hz) with Hamming, Hann, Blackman Windows (Gaussian Noise)")
